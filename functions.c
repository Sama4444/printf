 ...
 */
int print_char(val_list types, char buffer[],
 ...
 * @width: width get
 * @precision: specification prescision
 * @size: specifier size
 * Return: number of char chas printed
 */
 ...
 * Return: number of chars printed
 */
int print_percent(val_list types, char buffer[],
	int flags, int width, int precision, int size)
{
	UNUSED(types);
	UNUSED(buffer);
